...
* Agents preparing an RC or stable release build must create and push the tag themselves from the correct branch (`rc-upgrade` for RCs, `main` for stable). Example: `git checkout rc-upgrade && git pull && git tag v1.0.0-rc.1 && git push origin v1.0.0-rc.1`.
