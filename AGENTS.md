...
* Agents preparing an RC or stable release build must create and push the tag themselves from the correct branch (`rc-upgrade` for RCs, `main` for stable). Example: `git checkout rc-upgrade && git pull && git tag v0.2.0-rc.7 && git push origin v0.2.0-rc.7`.
